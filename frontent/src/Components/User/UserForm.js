...
const UserForm = () => {
    ...
    const donate = () => {
        ...
        axios.post("https://blood-donation-3tl1.onrender.com/user/donate", formData, { withCredentials: true }).then((r) => {
    ...
    const request = () => {
        ...
        axios.post("https://blood-donation-3tl1.onrender.com/user/request", formData, { withCredentials: true }).then((r) => {
